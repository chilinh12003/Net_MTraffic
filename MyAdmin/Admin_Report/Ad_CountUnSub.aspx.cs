...
{
    public partial class Ad_CountUnSub : System.Web.UI.Page
    {
        public GetRole mGetRole;
        public int PageIndex = 1;
        UnSubscriber mSub = new UnSubscriber();
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    mGetRole = new GetRole(MySetting.AdminSetting.ListPage.ReportCountSub, Member.MemberGroupID());
                }
                else
                {
        ...
        int Admin_Paging1_GetTotalPage_Callback_Change()
        {
            try
            {
                ...
                return mSub.Total_Count(SearchType, ServiceID);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        DataTable Admin_Paging1_GetData_Callback_Change()
        {
            try
            {
                ...
                return mSub.Search_Count(SearchType, ServiceID, SortBy);
            }
            catch (Exception ex)
            {
                throw ex;
