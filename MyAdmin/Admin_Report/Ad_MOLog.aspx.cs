...
{
    public partial class Ad_MOLog : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    mGetRole = new GetRole(MySetting.AdminSetting.ListPage.MOLog, Member.MemberGroupID());
                }
                else
                {
        ...
        DataTable Admin_Paging1_GetData_Callback_Change()
        {
            try
            {
                ...
                return mMOLog.Search(SearchType, Admin_Paging1.mPaging.BeginRow, Admin_Paging1.mPaging.EndRow, SearchContent, PID, ServiceID,0,0, BeginDate, EndDate, SortBy);
            }
            catch (Exception ex)
            {
                throw ex;
