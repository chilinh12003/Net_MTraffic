<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Ad_ChargeLog.aspx.cs" Inherits="MyAdmin.Admin_Report.Ad_ChargeLog" %>
    ...
    <table class="Data" border="0" cellpadding="0" cellspacing="0">
        <tbody>
            <tr class="Table_Header">
                ...
                <th>Kênh</th>               
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_1" CommandArgument="ChargeDate DESC" OnClick="lbtn_Sort_Click">Ngày trả tin</asp:LinkButton>
                </th>
                <th class="Table_TR">
                </th>
            </tr>
