...
{
    public partial class Ad_ChargeByDay_Price : System.Web.UI.Page
    {
        ...
        int Admin_Paging1_GetTotalPage_Callback_Change()
        {
            try
            {
                ...
                return mChargeLog.TotalRow_ByDay_Price(SearchType, ServiceID, BeginDate, EndDate);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        DataTable Admin_Paging1_GetData_Callback_Change()
        {
            try
            {
                ...
                return mChargeLog.Search_ByDay_Price(SearchType, Admin_Paging1.mPaging.BeginRow, Admin_Paging1.mPaging.EndRow, ServiceID,  BeginDate, EndDate, SortBy);
            }
            catch (Exception ex)
            {
                throw ex;
