<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Ad_Street.aspx.cs" Inherits="MyAdmin.Admin_News.Ad_Street" %>
    ...
    <table class="Data" border="0" cellpadding="0" cellspacing="0">
        <tbody>
            <tr class="Table_Header">
                ...
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_1" CommandArgument="StreetID ASC" OnClick="lbtn_Sort_Click">Mã</asp:LinkButton>
                </th>
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_2" CommandArgument="StreetName ASC" OnClick="lbtn_Sort_Click">Tên màu</asp:LinkButton>
                </th>    
                 <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_3" CommandArgument="PositionID ASC" OnClick="lbtn_Sort_Click">Địa điểm</asp:LinkButton>
                </th>          
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_4" CommandArgument="Priority DESC" OnClick="lbtn_Sort_Click">Ưu Tiên</asp:LinkButton>
                </th>
                <th>
                    Active
                </th>
            ...
            <asp:Repeater runat="server" ID="rpt_Data">
                <ItemTemplate>
                    <tr class="Table_Row_1">
                        ...
                        <td>
                            <a href="Ad_Street_Edit.aspx?ID=<%#Eval("StreetID") %>">
                                <%#Eval("StreetName")%></a>
                        </td>                      
                         <td>
                            <%#Eval("PositionName")%>
                        ...
                        <td align="center" width="10">
                            <%#"<input type='checkbox' id='CheckAll_" + Container.ItemIndex.ToString() + "' value='" + Eval("StreetID").ToString() + "' />"%>
                        </td>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cph_Javascript" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function EditData()
        {
            if (BeforeEditData())
            {
                document.location = '../Admin_News/Ad_Street_Edit.aspx?ID=' + hid_ListCheckAll.value;
