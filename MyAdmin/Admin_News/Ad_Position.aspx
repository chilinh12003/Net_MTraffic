<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Ad_Position.aspx.cs" Inherits="MyAdmin.Admin_News.Ad_Position" %>
    ...
    <table class="Data" border="0" cellpadding="0" cellspacing="0">
        <tbody>
            <tr class="Table_Header">
                ...
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_1" CommandArgument="PositionID ASC" OnClick="lbtn_Sort_Click">Mã</asp:LinkButton>
                </th>
                <th>
                    <asp:LinkButton runat="server" CssClass="Sort" ID="lbtn_Sort_2" CommandArgument="PositionName ASC" OnClick="lbtn_Sort_Click">Tên màu</asp:LinkButton>
                </th>            
                <th>
            ...
            <asp:Repeater runat="server" ID="rpt_Data">
                <ItemTemplate>
                    <tr class="Table_Row_1">
                        ...
                        <td>
                            <a href="Ad_Position_Edit.aspx?ID=<%#Eval("PositionID") %>">
                                <%#Eval("PositionName")%></a>
                        </td>                      
                         <td>
                            <%#Eval("Priority")%>
                        ...
                        <td align="center" width="10">
                            <%#"<input type='checkbox' id='CheckAll_" + Container.ItemIndex.ToString() + "' value='" + Eval("PositionID").ToString() + "' />"%>
                        </td>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cph_Javascript" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function EditData()
        {
            if (BeforeEditData())
            {
                document.location = '../Admin_News/Ad_Position_Edit.aspx?ID=' + hid_ListCheckAll.value;
