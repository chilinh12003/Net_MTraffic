...
namespace MyMTraffic.Sub
{
    public class UnSubscriber
    {
        ...
        /// <param name="ServiceID"></param>
        /// <returns></returns>
        public DataTable Search_Count(int Type, int ServiceID, int PartnerID, string OrderBy)
        {
            try
            {
                ...
                return mGet.GetDataTable("Sp_UnSubscriber_Search_Count_Partner", mPara, mValue);
        ...
        public int Total_Count(int Type, int ServiceID, int PartnerID)
        {
            try
            {
                ...
                return (int)mGet.GetExecuteScalar("Sp_UnSubscriber_Search_Count_Partner", mPara, mValue);
            }
            catch (Exception ex)
            {
                throw ex;
