<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Ad_HistoryCharge.aspx.cs" Inherits="MyCCare.Admin_CCare.Ad_HistoryCharge" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Content" runat="server">
    ...
    <div class='tabtracuusddv'>
        <ul>
            ...
            <li><a href='Ad_HistoryCharge.aspx' class='select'>Lịch sử trừ cước</a></li>
