<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Ad_HistoryUsing.aspx.cs" Inherits="MyCCare.Admin_CCare.Ad_HistoryUsing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Content" runat="server">
    ...
    <div class='tabtracuusddv'>
        ...
        <li><a href='Ad_HistoryUsing.aspx' class='select'>Lịch sử sử dụng</a></li>
    ...
    <table class='tbl_style'>
        <thead>
            <tr>
                ...
                <th>Gói cước</th>
                <th>Thao tác KH</th>
                <th style="width:300px;">Hệ thống phản hồi</th>
                <th>Kênh</th>
                <th>Đầu số DV</th>
            </tr>
        </thead>
